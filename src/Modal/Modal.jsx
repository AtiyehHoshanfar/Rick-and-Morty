...
function Modal() {
  ...
  return (
    <div className="flex justify-center ">
      <div className="fixed top-0 z-[2] right-0 backdrop-blur-md w-full h-screen"></div>
  ...
  return (
    <div className="p-[6px] rounded-xl bg-slate-600 flex flex-row hover:shadow-md transition-all hover:bg-slate-500">
      ...
      <div className="p-2 flex flex-col py-3 justify-between">
        <h2 className="font-bold text-lg mb-2 sm:text-xl">{favoriteCharacter.gender==="Male"?"👨🏼":"👩🏼"} {favoriteCharacter.name}</h2>
